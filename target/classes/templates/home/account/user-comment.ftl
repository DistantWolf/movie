...
<head>
    ...
    <title>用户中心-修改个人资料|大剧院_影剧在线选座购票平台</title>
    ...
    <div class="container fn-clear">
        ...
        <div class="box-con userinfo-usercenter index-usercenter">
            <div class="title tag fn-clear">
                <span <#if type == 0>class="act"</#if>><a href="user-comment">影剧评价</a></span>
                <span <#if type == 1>class="act"</#if>><a href="user-comment?type=1">剧院评价</a></span>
            </div>
            <div class="box-con comment-usercenter order-recently">
	            <div class="fn-clear th">
                    <span class="p1" style="width:200px;"><#if type==0>影剧<#else>剧院</#if></span>
