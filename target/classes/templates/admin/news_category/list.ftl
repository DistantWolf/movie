              ...
              <div class="card-toolbar clearfix">
                <form class="pull-right search-bar" method="get" action="list" role="form">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" value="${name!""}" name="name" placeholder="请输入分类名称">
              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <#if pageBean.content??>
                      <#list pageBean.content as newsCategory>
                      <tr>
                        <td style="vertical-align:middle;">
                          <label class="lyear-checkbox checkbox-primary">
                            <input type="checkbox" name="ids[]" value="${newsCategory.id}"><span></span>
                          </label>
                        </td>
                        <td style="vertical-align:middle;">${newsCategory.name}</td>
                        <td style="vertical-align:middle;">${newsCategory.remark!""}</td>
                        <td style="vertical-align:middle;" style="vertical-align:middle;"><font class="text-success">${newsCategory.createTime}</font></td>
                      </tr>
                    </#list>
                    <#else>
...
function deleteReq(id,url){
	$.ajax({
		...
		success:function(data){
			if(data.code == 0){
				showSuccessMsg('新闻分类删除成功!',function(){
