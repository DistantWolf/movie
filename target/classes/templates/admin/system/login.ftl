  ...
  <div class="lyear-login">
    <div class="login-center">
      <div class="login-header text-center">
        <a href="" style="font-size: 18px;color: #ac2925;">大剧院影剧后台管理系统</a>
      </div>
      ...
      <footer class="col-sm-12 text-center">
        <p class="m-b-0">Copyright © 2024 <a href="https://www.chncpa.org/" target="_blank">【国家大剧院】</a>. All right reserved</p>
        <p class="m-b-0"><a href="/home/index/index" target="_blank">【进入前台】</a></p>
      </footer>
    </div>
  </div>
</div>
