              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <#if pageBean.content??>
                      <#list pageBean.content as cinemaComment>
                      <tr>
                        <td style="vertical-align:middle;">
                          <label class="lyear-checkbox checkbox-primary">
                            <input type="checkbox" name="ids[]" value="${cinemaComment.id}"><span></span>
                          </label>
                        </td>
                        <td style="vertical-align:middle;">
                        	<a href="/home/cinema/detail?id=${cinemaComment.cinema.id}" target="_blank">${cinemaComment.cinema.name}</a>
                        </td>
                        <td style="vertical-align:middle;">${cinemaComment.account.mobile}</td>
                        <td style="vertical-align:middle;">
                        	${cinemaComment.rate}
                        </td>
                        <td style="vertical-align:middle;">
                        ...
                        <td style="vertical-align:middle;" style="vertical-align:middle;"><font class="text-success">${cinemaComment.createTime}</font></td>
                      </tr>
                    </#list>
