    ...
    <main class="lyear-layout-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>添加排剧场次</h4></div>
              <div class="card-body">
                <form action="add" id="cinema-hall-add-form" method="post" class="row">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required js-datetimepicker" id="show-date" name="showDate" value="" placeholder="请选择场次上映日期" tips="请选择场次上映日期" data-side-by-side="true" data-locale="zh-cn" data-format="YYYY-MM-DD" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">上映时间</span>
                    <input type="text" class="form-control required js-datetimepicker" id="show-time" name="showTime" value="" placeholder="请选择场次上映时间" tips="请选择场次上映时间" data-side-by-side="true" data-locale="zh-cn" data-format="HH:mm" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">剧票原价</span>
                    <input type="number" class="form-control required" id="old-price" name="oldPrice" value="" placeholder="请填写剧票原价" tips="请填写剧票原价" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">剧票现价</span>
                    <input type="number" class="form-control required" id="new-price" name="newPrice" value="" placeholder="请填写剧票现价" tips="请填写剧票现价" />
                  </div>
