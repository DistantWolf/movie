    ...
    <main class="lyear-layout-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>编辑影剧</h4></div>
              <div class="card-body">
                <form action="add" id="user-add-form" method="post" class="row">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required" id="name" name="name" value="${movie.name}" placeholder="请输入影剧名" tips="请填写影剧名" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">影剧摘要</span>
                    <input type="text" class="form-control" id="abs" name="abs" value="${movie.abs}" placeholder="请输入影剧摘要" tips="请输入影剧摘要" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">影剧类型</span>
                    ...
                    <input type="hidden" name="type" id="movie-type" value="${movie.type!""}" class="required" tips="请选择影剧类型">
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">影剧地区</span>
                  ...
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">影剧语言</span>
                  ...
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">影剧导演</span>
                    <input type="text" class="form-control required" id="directedBy" name="directedBy" value="${movie.directedBy}" placeholder="请填写影剧导演" tips="请填写影剧导演" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">影剧主演</span>
                    <input type="text" class="form-control required" id="actor" name="actor" value="${movie.actor}" placeholder="请填写影剧主演" tips="请填写影剧主演" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">影剧片长</span>
                    <input type="number" class="form-control required" id="time" name="time" value="${movie.time}" placeholder="请填写影剧片长（单位：分钟）" tips="请填写影剧片长" />
                  	<span class="input-group-addon">分钟</span>
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">上映时间</span>
                    <input type="text" class="form-control required js-datetimepicker" id="showTime" name="showTime" value="${movie.showTime}" placeholder="请选择影剧上映日期" tips="请选择影剧上映日期" data-side-by-side="true" data-locale="zh-cn" data-format="YYYY-MM-DD HH:mm:ss"  />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">剧情介绍</span>
                    <textarea class="form-control" id="info" name="info" rows="5" placeholder="请填写影剧剧情介绍">${movie.info!""}</textarea>
                  </div>
                  <div class="input-group m-b-10">
                    是否上映：
	...
	$("#add-form-submit-btn").click(function(){
		...
		$.ajax({
			...
			success:function(data){
				if(data.code == 0){
					showSuccessMsg('影剧编辑成功!',function(){
