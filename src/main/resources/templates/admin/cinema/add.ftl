    ...
    <main class="lyear-layout-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>添加影剧院</h4></div>
              <div class="card-body">
                <form action="add" id="cinema-add-form" method="post" class="row">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required" id="name" name="name" value="" placeholder="请输入影剧院名" tips="请填写影剧院名" />
                  </div>
                  <div class="input-group m-b-10">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="hidden" name="cinemaService" id="cinema-service" class="required" tips="请选择影剧院服务">
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">剧院地址</span>
                    <input type="text" class="form-control required" id="address" name="address" value="" placeholder="请填写影剧院详细地址" tips="请填写影剧院详细地址" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">联系电话</span>
                    <input type="text" class="form-control required" id="tel" name="tel" value="" placeholder="请填写影剧院联系电话" tips="请填写影剧院联系电话" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">交通路线</span>
                    <input type="text" class="form-control required" id="transport" name="transport" value="" placeholder="请填写影剧院交通路线" tips="请填写影剧院交通路线" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">剧院介绍</span>
                    <textarea class="form-control" id="info" name="info" rows="5" placeholder="请填写影剧院介绍"></textarea>
                  </div>
