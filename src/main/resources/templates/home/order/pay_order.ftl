...
<head>
    ...
    <title>确认支付订单-大剧院_影剧在线选座购票平台</title>
    ...
    <div class="order-info-payorder">
        ...
        <div class="box-order-info fn-clear">
                <div class="film-info" data-seatnum="2">
                    ...
                    <p>
                        <span>剧院：</span><span>${order.cinemaHallSession.cinema.name}</span>
                    </p>
                    <p>
                        <span>剧厅：</span><span>${order.cinemaHallSession.cinemaHall.name}</span>
                   	</p>
                    <p>
            ...
            <div class="container fn-clear">
                ...
                <div class="pay">
                        <p>
                            ...
                            <span class="tip-ck fn-hide">使用观影卡兑换影剧票*<em>1</em>，</span>
