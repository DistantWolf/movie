    ...
    <div class="fiml-chooseseat fn-clear">
        ...
        <div class="box-film-info">
            ...
            <div class="film-detail">
                <p><span class="cor999">剧院：</span><span>${cinemaHallSession.cinema.name}</span></p>
                <p><span class="cor999">剧厅：</span><span>${cinemaHallSession.cinemaHall.name}</span></p>
