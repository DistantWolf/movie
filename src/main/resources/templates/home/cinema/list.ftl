...
<div class="wrapper-cinemalist fn-clear">
    ...
    <div style="overflow:hidden">
        <div style="padding-bottom:10px;padding-top:40px;border-bottom:1px solid #f5f5f5;overflow:hidden">
            <span class="fn-left" style="font-size: 24px;"><#if ylrc_area??>${ylrc_area.name}影剧院<#else>全部影剧院</#if></span>
            <span class="fn-left cor999" style="margin-left: 20px;padding-top:5px;">共 ${cinemaList?size} 家剧院，上映场次 <font id="show-total-session" color="red">0</font> 场</span>
        </div>
