        ...
        <div class="con">
            <ul class="help-aq">
                <li class="pb10 act">
                    ...
                    <div class="hepl-info">
                        <p>1、首先注册成为大剧院影剧票会员并登录（已有账号可以忽略此步）。</p>
                        <p>2、选择想看的影片或者剧院</p>
                ...
                <li>
                    ...
                    <div class="hepl-info">
                        ...
                        <p>锁定座位是在网络售票系统中将座位锁定，而此时剧院本地系统仍然可以售卖对应的座位。而最后买票的时候， 网售系统要与地面系统确认购票。因此，如果期间座位被剧院售出，就会发生买票失败的情况。</p>
                ...
                <li>
                    ...
                    <div class="hepl-info">
                        ...
                        <p>5、注册成功后，使用注册的手机号和密码登录，即可开始使用大剧院影剧票购票</p>
