...
import com.demo.movie.service.admin.OperaterLogService;
import com.demo.movie.service.admin.RoleService;
import com.demo.movie.service.admin.UserService;
...
public class UserController {
	...
	public Result<Boolean> add(User user){
		...
		operaterLogService.add("添加会员，用户名：" + user.getUsername());
	...
	public Result<Boolean> delete(@RequestParam(name="id",required=true)Long id){
		...
		operaterLogService.add("添加会员，用户ID：" + id);
		return Result.success(true);
	}
}
