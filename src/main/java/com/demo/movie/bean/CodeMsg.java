...
public class CodeMsg {
	...
	public static CodeMsg ADMIN_AREA_DELETE_ERROR = new CodeMsg(-9002, "该地域下存在剧院等关联信息，不可删除！");
	public static CodeMsg HOME_AREA_NO_EXIST = new CodeMsg(-9003, "地域不存在！");

	//影剧管理类错误码
	public static CodeMsg ADMIN_MOVIE_DELETE_ERROR = new CodeMsg(-10001, "该影剧下存在订单等关联信息，不可删除！");
	public static CodeMsg ADMIN_CINEMA_DELETE_ERROR = new CodeMsg(-10002, "该影剧院下存在剧厅等关联信息，不可删除！");
	public static CodeMsg ADMIN_CINEMA_SAVE_ERROR = new CodeMsg(-10003, "影剧院保存失败，请联系管理员！");
	public static CodeMsg ADMIN_CINEMA_HALL_SAVE_ERROR = new CodeMsg(-10004, "剧厅保存失败，请联系管理员！");
	public static CodeMsg ADMIN_CINEMA_HALL_DELETE_ERROR = new CodeMsg(-10005, "该剧厅下存在座位等关联信息，不可删除！");
	...
	public static CodeMsg ADMIN_CINEMA_HALL_SESSION_SAVE_EXIST = new CodeMsg(-10008, "该剧厅在当前时间段已经排剧，请重新选择上映时间！");
	//新闻资讯管理类错误
