...
public class Cinema extends BaseEntity {
	...
	private String name;//影剧院名称
	
	@ManyToOne
	@JoinColumn(name="area_id")
	private Area area;//影剧院地区
	...
	private String cinemaService;//剧院服务
	...
	@Transient
	private List<CinemaServices> cinemaServiceList;//用于直接显示在页面的影剧院服务.不需要保存到数据库
